...
if (!empty($_FILES['photo']['name'])) {
    ...
    if (move_uploaded_file($_FILES['photo']['tmp_name'], $target_file)) {
        ...
        $photo_path = "uploads/foto_guru/" . $new_file_name;

        // Perbarui path foto di database
        $update_photo_query = "UPDATE guru SET photo = '$photo_path' WHERE username = '$username'";
...
<div class="container mx-auto mt-8 px-4">
    <h2 class="text-3xl font-bold mb-6">Profile Guru</h2>
        ...
        <form method="POST" enctype="multipart/form-data"> <!-- Tambahkan enctype untuk upload file -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="nip" name="nip" value="<?php echo $user['nip']; ?>" class="w-full px-4 py-2 border border-gray-300 rounded-md" readonly>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="username" name="username" value="<?php echo $user['username']; ?>" class="w-full px-4 py-2 border border-gray-300 rounded-md" required>
                </div>
                <div class="mb-4">
...
if (isset($_POST['update_profile'])) {
    ...
    $nip = mysqli_real_escape_string($conn, $_POST['nip']); // Menambahkan nip
    ...
    $update_query = "UPDATE guru SET username = '$username', email = '$email', nip = '$nip', password = '$password', photo = '$photo_path' WHERE username = '$username'";
